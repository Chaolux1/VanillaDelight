...
public class FurnitureContainerBlockEntity extends FurnitureBlockEntity implements Container, MenuProvider {
    ...
    protected void saveAdditional(CompoundTag compoundTag, HolderLookup.Provider provider) {
        ...
        if(this.component != null) {
            compoundTag.putString("CustomName",Component.Serializer.toJson(this.component,provider));
        }
    }
    ...
    public void loadAdditional(CompoundTag compoundTag,HolderLookup.Provider provider) {
        ...
        if(compoundTag.contains("CustomName",8)) this.component=Component.Serializer.fromJson(compoundTag.getString("CustomName"),provider);
    }
