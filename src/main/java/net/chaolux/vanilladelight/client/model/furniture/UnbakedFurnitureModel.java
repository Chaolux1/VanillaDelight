...
public class UnbakedFurnitureModel implements IUnbakedGeometry<UnbakedFurnitureModel> {
    ...
    @Override
    public BakedModel bake(IGeometryBakingContext iGeometryBakingContext, ModelBaker modelBaker, Function<Material, TextureAtlasSprite> atlasHolderFunction, ModelState modelState, ItemOverrides itemOverrides) {
