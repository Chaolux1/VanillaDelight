...
public enum ModularStoveModelLoader implements IGeometryLoader<UnbakedModularStoveModel> {
    ...
    public UnbakedModularStoveModel read(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
        ...
        ResourceLocation location=new ResourceLocation(GsonHelper.getAsString(jsonObject,"particle","minecraft:block/bricks"));
        ResourceLocation fixedSide=new ResourceLocation(GsonHelper.getAsString(jsonObject,"fixed_side"));
        ResourceLocation topOff=new ResourceLocation(GsonHelper.getAsString(jsonObject,"top_off"));
        ResourceLocation arc=new ResourceLocation(GsonHelper.getAsString(jsonObject,"arc"));
        ...
        for(Map.Entry<String, JsonElement> stringJsonElementEntry : object.entrySet()) {
            ...
            ResourceLocation front=new ResourceLocation(GsonHelper.getAsString(style,"front"));
            ResourceLocation top=new ResourceLocation(GsonHelper.getAsString(style,"top"));
