...
public class FoodValues {
    public static final FoodProperties APPLE_SALAD = (new FoodProperties.Builder()).nutrition(7).saturationModifier(0.6F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 700, 2, false, false), 1.0F).build();
    public static final FoodProperties BERRIES_SALAD = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.5F).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 0, false, false), 1.0F).build();
    public static final FoodProperties CARAMELIZED_CHICKEN = (new FoodProperties.Builder()).nutrition(8).saturationModifier(0.7F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 400, 0, false, false), 1.0F).build();
    public static final FoodProperties CARROT_SALAD = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.4F).effect(() -> new MobEffectInstance(MobEffects.JUMP, 400, 0, false, false), 1.0F).build();
    ...
    public static final FoodProperties CARAMEL_CANDY = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.8F).fast().effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 200, 0, false, false), 1.0F).build();
    ...
    public static final FoodProperties GLOW_BERRIES_CANDY = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.8F).fast().effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 400, 0, false, false), 1.0F).build();
    public static final FoodProperties GOLDEN_APPLE_SLICE = (new FoodProperties.Builder()).nutrition(2).saturationModifier(1.2F).fast().effect(() -> new MobEffectInstance(MobEffects.ABSORPTION, 100, 0, false, false), 1.0F).build();
    public static final FoodProperties HONEY_CANDY = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.8F).fast().effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 0, false, false), 1.0F).build();
    public static final FoodProperties HONEY_PUDDING = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.9F).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 1000, 1, false, false), 1.0F).build();
    public static final FoodProperties CHORUS_PIE_SLICE = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.8F).fast().effect(() -> new MobEffectInstance(MobEffects.SLOW_FALLING, 600, 1, false, false), 1.0F).build();
    public static final FoodProperties MELON_PIE_SLICE = (new FoodProperties.Builder()).nutrition(5).saturationModifier(0.8F).fast().effect(() -> new MobEffectInstance(MobEffects.JUMP, 600, 1, false, false), 1.0F).build();
